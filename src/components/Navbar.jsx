  ...
  return (
    <nav className="bg-blue-800 text-white sticky top-0 z-50">
      <div className="grid justify-items-center items-center border-b border-gray-600">
        ...
        <button
          onClick={toggleMenu}
          className="text-xl w-full md:hidden flex justify-center items-center"
        >
          {isOpen ? <FiX /> : <FiMenu />}
        </button>
        ...
        >
          ...
          <div
            ...
            onClick={() =>
              setShowDropdown(
                showDropdown === "authorPast" ? null : "authorPast"
              )
            }
          >
            <a
            ...
            >
              ...
              <FiChevronDown
                className={`transition-transform ${
                  showDropdown === "authorPast" ? "rotate-180" : ""
                }`}
              />
            </a>
            <AnimatePresence>
          ...
          <div
            ...
            onClick={() =>
              setShowDropdown(
                showDropdown === "keynoteSponsors" ? null : "keynoteSponsors"
              )
            }
          >
            <a
            ...
            >
              ...
              <FiChevronDown
                className={`transition-transform ${
                  showDropdown === "keynoteSponsors" ? "rotate-180" : ""
                }`}
              />
            </a>
            <AnimatePresence>
